...
public class RegistroUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comBox_rango = new javax.swing.JComboBox<>();
        ...
        txt_confirmPass.setText("jPasswordField2");
        ...
        comBox_rango.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0", "1", "2", "3" }));
        comBox_rango.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comBox_rangoActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(comBox_rango, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(21, 21, 21))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(196, 196, 196)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(comBox_rango, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String confirmpass = new String(txt_confirmPass.getPassword());
        ...
        if (pass.equals(confirmpass)){
            ...
            mod.setUsuario(Integer.parseInt(txt_usuario.getText()));
            mod.setPassword(newpass);
            mod.setId_tipo(comBox_rango.getSelectedIndex());
            mod.setLast_session(fecha.format(date));
            System.out.println(mod.getLast_session());
             if(modsql.registrar(mod)){
                 JOptionPane.showMessageDialog(null, "Exito gurdar");
                 dispose();
             }else{
                 JOptionPane.showMessageDialog(null, "error gurdar");
             }
        }else{
    ...
    private void comBox_rangoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comBox_rangoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comBox_rangoActionPerformed
    ...
    private javax.swing.JComboBox<String> comBox_rango;
